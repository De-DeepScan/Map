...
import { CameraResetManager } from './CameraResetManager';
 ...
 */
const EarthGroup = memo(function EarthGroup({ onCountrySelect, showGeoJson = true, geoJsonSettings = {}, onStatsUpdate, startAnimation = true, totalInfectionTime = 900000, triggerRegression = false, onRegressionComplete }) {
...
export function Scene({
  ...
  totalInfectionTime = 900000,  // 15 minutes par défaut
  ...
  // Ref pour OrbitControls (utilisé par CameraResetManager)
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      */}
        ...
        {/* Gestionnaire de reset de caméra - coordonne caméra et OrbitControls */}
        {/* Placé APRÈS OrbitControls pour garantir que la ref soit disponible */}
        <CameraResetManager
